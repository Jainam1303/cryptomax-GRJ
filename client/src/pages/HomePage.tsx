...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-neutral-100">
      {/* Navigation */}
      <nav className="border-b border-neutral-800 bg-neutral-900/60 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center space-x-2">
                <img src="/logos/CMlogo.svg" alt="CryptoMax" className="w-12 h-12 rounded-lg" />
                <h1 className="text-2xl font-bold gradient-text">CryptoMax</h1>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated ? (
                <Link to="/dashboard">
                  <Button className="bg-gradient-to-r from-emerald-500 to-lime-500 hover:from-emerald-400 hover:to-lime-400 text-black font-semibold">Dashboard</Button>
                </Link>
              ) : (
                <>
                  <Link to="/login">
                    <Button variant="ghost" className="text-white hover:text-neutral-300">
                      Sign In
                    </Button>
                  </Link>
                  <Link to="/register">
                    <Button className="bg-gradient-to-r from-emerald-500 to-lime-500 hover:from-emerald-400 hover:to-lime-400 text-black font-semibold">Get Started</Button>
                  </Link>
                </>
              )}
            </div>
      ...
      <section className="relative overflow-hidden">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {isAuthenticated ? (
                <>
                  <Link to="/invest">
                    <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-lime-500 hover:from-emerald-400 hover:to-lime-400 text-black font-semibold px-8 py-3">
                  ...
                  <Link to="/dashboard">
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-neutral-800 text-white hover:bg-neutral-800/40 px-8 py-3 bg-transparent"
                    >
                      View Dashboard
                    </Button>
                  </Link>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 animate-pulse">
            <Card className="bg-neutral-900/60 border border-neutral-800 backdrop-blur-sm">
            ...
            <Card className="bg-neutral-900/60 border border-neutral-800 backdrop-blur-sm">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-emerald-400 text-xs">+3.8%</p>
                </div>
              </div>
            </Card>
          </div>
      ...
      <section id="features" className="py-24 bg-black/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-neutral-900/60 border border-neutral-800 backdrop-blur-sm hover:border-emerald-500/40 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-neutral-400">Total Volume Traded</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-neutral-400">Supported Coins</div>
            </div>
            <div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-10 text-center backdrop-blur-md">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-100 mb-4">Ready to Maximize Your Crypto Portfolio?</h2>
      ...
      {/* Footer */}
      <footer className="bg-neutral-900/60 border-t border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="gradient-text font-bold text-lg mb-4">CryptoMax</h3>
