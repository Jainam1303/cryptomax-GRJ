...
const AIAssistantSection = () => {
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-b from-black to-neutral-900/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-neutral-900/60 border border-neutral-800 rounded-full px-4 py-2">
                <Sparkles className="h-4 w-4 text-emerald-400" />
                <span className="text-sm font-medium text-neutral-300">Introducing CryptoMax Cortex, coming Fall 2025</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="bg-neutral-900/60 border border-neutral-800 p-6 hover-lift">
          ...
          <div className="relative">
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-emerald-500/20 rounded-full animate-bounce"></div>
